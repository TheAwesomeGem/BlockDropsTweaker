 ...
 */
public class DropToolRemoveCommand extends BlockDropsBaseCommand
{
    @Override
    ...
    protected void onCommand(MinecraftServer server, EntityPlayer player, String[] args) throws CommandException
    {
        ...
        dropData.tools.remove(toolInfo);
        ...
        if(args.length == 1)
        {
            if(sender instanceof EntityPlayer)
            {
                ...
                if (blockDropData != null)
                {
                    ...
                    if (dropData != null)
                    {
                        tabList.addAll(getListOfStringsMatchingLastWord(args, dropData.tools));
                    }
                }
            }
        }
