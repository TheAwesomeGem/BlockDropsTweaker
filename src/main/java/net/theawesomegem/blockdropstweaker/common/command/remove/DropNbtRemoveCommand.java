 ...
 */
public class DropNbtRemoveCommand extends BlockDropsBaseCommand
{
    @Override
        ...
        if(args.length == 1)
        {
            if(sender instanceof EntityPlayer)
            {
                ...
                if (blockDropData != null)
                {
                    ...
                    if (dropData != null)
                    {
                        tabList.addAll(getListOfStringsMatchingLastWord(args, dropData.nbtList));
                    }
                }
            }
        }
