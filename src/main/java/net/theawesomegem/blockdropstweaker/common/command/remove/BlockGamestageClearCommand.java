 ...
 */
public class BlockGamestageClearCommand extends BlockDropsBaseCommand
{
    @Override
    ...
    protected void onCommand(MinecraftServer server, EntityPlayer player, String[] args) throws CommandException
    {
        ...
        blockDropData.gameStageList.clear();

        player.sendMessage(ChatUtil.getNormalMessage("Cleared all gamestages."));
    }
}