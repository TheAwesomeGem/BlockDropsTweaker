 ...
 */
public class BlockEnchantClearCommand extends BlockDropsBaseCommand
{
    @Override
    ...
    protected void onCommand(MinecraftServer server, EntityPlayer player, String[] args) throws CommandException
    {
        ...
        blockDropData.enchantmentList.clear();

        player.sendMessage(ChatUtil.getNormalMessage("Cleared all enchantments."));
    }
}
