 ...
 */
public class DropTraitClearCommand extends BlockDropsBaseCommand
{
    @Override
    ...
    protected void onCommand(MinecraftServer server, EntityPlayer player, String[] args) throws CommandException
    {
        ...
        dropData.traitList.clear();

        player.sendMessage(ChatUtil.getNormalMessage("Cleared all traits."));
    }
}
