 ...
 */
public class BlockBiomeClearCommand extends BlockDropsBaseCommand
{
    @Override
    ...
    protected void onCommand(MinecraftServer server, EntityPlayer player, String[] args) throws CommandException
    {
        ...
        blockDropData.biomes.clear();

        player.sendMessage(ChatUtil.getNormalMessage("Cleared all biomes."));
    }
}
