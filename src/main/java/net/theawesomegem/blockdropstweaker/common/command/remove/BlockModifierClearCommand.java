 ...
 */
public class BlockModifierClearCommand extends BlockDropsBaseCommand
{
    @Override
    ...
    protected void onCommand(MinecraftServer server, EntityPlayer player, String[] args) throws CommandException
    {
        ...
        blockDropData.modifierList.clear();

        player.sendMessage(ChatUtil.getNormalMessage("Cleared all modifiers."));
    }
}
